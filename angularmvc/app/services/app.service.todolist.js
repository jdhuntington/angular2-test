...
var AppServiceTodoList = (function (_super) {
    ...
    function AppServiceTodoList(http) {
        ...
        this.http = http;
        this._getTodoListUrl = 'api/Tasks';
        this._getListAddUrl = 'api/Tasks/List';
        this._getListUpdateUrl = 'api/Tasks/List';
        this._getListDeleteUrl = 'api/Tasks/List';
        this._getTaskAddUrl = 'api/Tasks';
        this._getTaskUpdateUrl = 'api/Tasks';
        this._getTaskDeleteUrl = 'api/Tasks';
